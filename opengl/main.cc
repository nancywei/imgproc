...
//    stbi_image_free(prop_data);
    ...
    char* name = "app/src/main/assets/effect/nancytest";
  //  char* name= "app/src/main/assets/filter/chahui";
    auto* detection = new MakeFaceDetection();
    image_process.OnAction(name, 0, detection);
    //image_process.OnAction(name, 0, detection);
    //char* config_path= "app/src/main/assets/filter/chahui";
    int action_id = 0 , start_time = 0, end_time = 0;
    //image_process.OnFilter(config_path, action_id, start_time, end_time);
    //image_process.OnAction("param/spaceBear", 0,detection);
...
//        int process_id = face_point.OnDrawFrame(texture_id, prop_texture_id);
        image_process.OnUpdateEffectParam(0, "blurScreen", "stickerWidth", 0.23f);
        image_process.OnUpdateEffectParam(0, "blurScreen", "stickerX", 0.23f);
        image_process.OnUpdateEffectParam(0, "blurScreen", "stickerY", 0.23f);
        image_process.OnUpdateEffectParam(0, "blurScreen", "stickerRotate", (float)glfwGetTime() * 10);
