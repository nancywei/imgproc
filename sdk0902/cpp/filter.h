...
namespace trinity {
  ...
  static const char* BEAUTY_FRAGMENT_SHADER =
       ...
       "vec2 tex5 = vec2(textureCoordinate.x - 1.0 * fstep,textureCoordinate.y + fstep * ar);\n"
       "vec4 p5 = texture2D(inputImageTexture, tex5);\n"
       "vec2 tex6 = vec2(textureCoordinate.x - 2.0 * fstep,textureCoordinate.y + fstep * ar);\n"
       "vec4 p6 = texture2D(inputImageTexture, tex6);\n"
       "vec2 tex7 = vec2(textureCoordinate.x + 1.0 * fstep,textureCoordinate.y + fstep * ar);\n"
       "vec4 p7 = texture2D(inputImageTexture, tex7);\n"
       "vec2 tex8 = vec2(textureCoordinate.x + 2.0 * fstep,textureCoordinate.y + fstep * ar);\n"
       "vec4 p8 = texture2D(inputImageTexture, tex8);\n"
       "vec4 line1 = (p6 + 4.0 * p5 + 6.0 * p0 + 4.0 * p7 + p8)/16.0;                            \n"

       "vec2 te0 = vec2(textureCoordinate.x ,textureCoordinate.y + 2.0 * fstep * ar);\n"
       "vec4 pl0 = texture2D(inputImageTexture, te0);\n"
       "vec2 te5 = vec2(textureCoordinate.x - 1.0 * fstep,textureCoordinate.y + 2.0 * fstep * ar);\n"
       "vec4 pl5 = texture2D(inputImageTexture, te5);\n"
       "vec2 te6 = vec2(textureCoordinate.x - 2.0 * fstep,textureCoordinate.y + 2.0 * fstep * ar);\n"
       "vec4 pl6 = texture2D(inputImageTexture, te6);\n"
       "vec2 te7 = vec2(textureCoordinate.x + 1.0 * fstep,textureCoordinate.y + 2.0 * fstep * ar);\n"
       "vec4 pl7 = texture2D(inputImageTexture, te7);\n"
       "vec2 te8 = vec2(textureCoordinate.x + 2.0 * fstep,textureCoordinate.y + 2.0 * fstep * ar);\n"
       "vec4 pl8 = texture2D(inputImageTexture, te8);\n"
       "vec4 line2 = (pl6 + 4.0 * pl5 + 6.0 * pl0 + 4.0 * pl7 + pl8)/16.0;                            \n"

       "vec2 t0 = vec2(textureCoordinate.x ,textureCoordinate.y -  fstep * ar);\n"
       "vec4 pr0 = texture2D(inputImageTexture, t0);\n"
       "vec2 t5 = vec2(textureCoordinate.x - 1.0 * fstep,textureCoordinate.y - fstep * ar);\n"
       "vec4 pr5 = texture2D(inputImageTexture, t5);\n"
       "vec2 t6 = vec2(textureCoordinate.x - 2.0 * fstep,textureCoordinate.y -  fstep * ar);\n"
       "vec4 pr6 = texture2D(inputImageTexture, t6);\n"
       "vec2 t7 = vec2(textureCoordinate.x + 1.0 * fstep,textureCoordinate.y - fstep * ar);\n"
       "vec4 pr7 = texture2D(inputImageTexture, t7);\n"
       "vec2 t8 = vec2(textureCoordinate.x + 2.0 * fstep,textureCoordinate.y - fstep * ar);\n"
       "vec4 pr8 = texture2D(inputImageTexture, t8);\n"
       "vec4 line3 = (pr6 + 4.0 * pr5 + 6.0 * pr0 + 4.0 * pr7 + pr8)/16.0;                            \n"

       "vec2 tx0 = vec2(textureCoordinate.x ,textureCoordinate.y - 2.0 * fstep * ar);\n"
       "vec4 px0 = texture2D(inputImageTexture, tx0);\n"
       "vec2 tx5 = vec2(textureCoordinate.x - 1.0 * fstep,textureCoordinate.y - 2.0 * fstep * ar);\n"
       "vec4 px5 = texture2D(inputImageTexture, tx5);\n"
       "vec2 tx6 = vec2(textureCoordinate.x - 2.0 * fstep,textureCoordinate.y - 2.0 * fstep * ar);\n"
       "vec4 px6 = texture2D(inputImageTexture, tx6);\n"
       "vec2 tx7 = vec2(textureCoordinate.x + 1.0 * fstep,textureCoordinate.y - 2.0 * fstep * ar);\n"
       "vec4 px7 = texture2D(inputImageTexture, tx7);\n"
       "vec2 tx8 = vec2(textureCoordinate.x + 2.0 * fstep,textureCoordinate.y - 2.0 * fstep * ar);\n"
       "vec4 px8 = texture2D(inputImageTexture, tx8 );\n"
       "vec4 line4 = (px6 + 4.0 * px5 + 6.0 * px0 + 4.0 * px7 + px8)/16.0;                            \n"
       "vec4 blurColor = ( line4 + 4.0 * line3 + 6.0 * line0 + 4.0 * line1 + line2)/16.0;\n"
       "vec4 highpassColor = abs(sourceColor - blurColor);                                                                       \n"
        // 找到模糊之后RGB通道的最大值
//       "float intensity = 1.5 ;\n"
