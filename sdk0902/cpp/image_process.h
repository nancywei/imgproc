...
//#include "../../../../../../../Library/Android/sdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/include/c++/v1/map"
//#include "effect.h"
...
class ImageProcess {
 public:
    ...
    float* face_edge = new float[5];
 
    bool has_face = false;
    GLuint Process(GLuint texture_id, int width, int height);
  ...
  //  void OnAction(char* config_path, int action_id, FaceDetection* face_detection = nullptr);
    ...
    void OnDeleteFilter(int action_id = 0);
    void OnDeleteAllFilters();
...
//    std::map<int, Effect*> effects_;
 ...
 //   Filter*  filters_;
    ...
    unsigned char* pmask257_ = new unsigned char[sizeof (unsigned char) * 257 * 257 * 4];
